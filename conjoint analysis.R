...
preference_1 <- c(11,19,14,20,6,13,7,21,5,12,24,8,4,18,9,17,15,1,22,10,2,23,16,3) # Sayali
preference_2 <- c(10,18,8,22,24,20,9,11,7,21,23,19,4,6,2,15,17,13,3,5,1,14,16,12) # Akshay
preference_3 <- c(8,12,4,20,24,16,6,10,2,18,22,14,7,11,3,19,23,15,5,9,1,17,21,13) # Nidhi
preference_4 <- c(17,18,9,23,24,20,6,7,5,13,14,12,15,16,8,22,21,19,3,4,2,10,11,1) # Rajprakash
